...
const TeamSection: React.FC = () => {
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      name: "Sarah Le Roux",
      role: "Co-Founder",
      description: "Expert in healthcare technology and market expansion. Driving B2B sales and strategic partnerships.",
      image: "/images/sarah-le-roux.jpg",
      expertise: "Healthcare & Product Strategy"
    },
    {
      name: "Dr. Alexander Schmidt",
      role: "Lead Engineer",
      description: "Specialized in AI signal processing and embedded systems development. Tech backbone of HAVENIS core platform.",
      image: "/images/alexander-schmidt.jpg",
            ...
            <div
              ...
              >
                ...
                <div className="relative z-10">
                  {/* Avatar */}
                  <div className="w-24 h-24 mb-4 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-lg flex items-center justify-center text-white text-2xl font-bold overflow-hidden shadow-lg">
                    {member.image ? (
